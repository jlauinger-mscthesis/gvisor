...
func TestIPv4RetransmitIdentificationUniqueness(t *testing.T) {
	...
	// TODO(b/129291778) Once this socket option is supported by gVisor,
	// this call can simply assert success.
	...
	_, err := conn.ExpectData(&tb.TCP{}, samplePayload, time.Second)
	if err != nil {
